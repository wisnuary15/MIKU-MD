...
let { name, exp, diamond, lastclaim, registered, regTime, age, level, pasangan, role, warn, premium } = global.db.data.users[who]
...
▢ *🏆Role:* ${role}
▢ *📇 Register :* ${registered ? 'Sudah': 'Belum'}
▢ *⭐ Premium:* ${user.premiumTime > 0 ? "Yes": "No"} 
└──────────────`
